...
public class QuestionController {
    ...
    public String create(com.sbs.sbb.Question.QuestionForm questionFrom) {
//        model.addAttribute("questionFrom", new QuestionForm());
    ...
    public String questionCreate(
            @Valid com.sbs.sbb.Question.QuestionForm questionForm,
        ...
        Question q = this.questionService.create(questionForm.getSubject(), questionForm.getContent(), user);
    ...
    public String questionModify(@Valid com.sbs.sbb.Question.QuestionForm questionForm, BindingResult bindingResult,
    ...
    public String questionModify(com.sbs.sbb.Question.QuestionForm questionForm, @PathVariable("id") Integer id, Principal principal) {
        Question question = questionService.getQuestion(id);
